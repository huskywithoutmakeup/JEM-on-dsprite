...
class wide_basic(nn.Module):  # wide basic
    def __init__(self, in_planes, planes, dropout_rate, stride=1, norm=None, leak=.2):
        super(wide_basic, self).__init__()  # python3可以写成 super().__init__()
        self.lrelu = nn.LeakyReLU(leak)
        self.bn1 = get_norm(in_planes, norm)  # batch norm
...
class Wide_ResNet(nn.Module):
    def __init__(self, depth, widen_factor, num_classes=3, input_channels=1,
